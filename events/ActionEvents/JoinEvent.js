...
client.on("guildMemberAdd", async(member) => {
    let Embed = new MessageEmbed()
        ...
        .addField("<:clock:1011170596719173692> Account age", `${moment(member.user.createdAt).format('MMMM Do YYYY, h:mm:ss a')} - ${moment(member.user.createdAt, "YYYYMMDD").fromNow()}`, true)
        .setColor("GREEN")
