            ...
            switch(type){
                case "category":
                    await Guild.findOneAndUpdate({
                        ...
                        [`Modules.${cmdOpt}.Enabled`]: true
                    }).then((res) => {
                        return interaction.editReply({
                            embeds: [new Discord.MessageEmbed()
                                .setDescription(`Module **${cmdOpt}** has been __enabled__`)
                                .setColor("GREEN")   
                            ]
                        }).catch(err => {return console.log(err.stack)})
                    }).catch(err => {return console.log(err.stack)})
                ...
                case 'cmd':
                    await Guild.findOneAndUpdate({
                        ...
                        [`Commands.${cmdOpt}.Enabled`]: true
                    }).then((res) => {
                        return interaction.editReply({
                            embeds: [new Discord.MessageEmbed()
                                .setDescription(`Command **${cmdOpt}** has been __enabled__`)
                                .setColor("GREEN")   
                            ]
                        }).catch(err => {return console.log(err.stack)})
                    }).catch(err => {return console.log(err.stack)})
